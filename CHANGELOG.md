...
- An in-place append that is not write-gathered — an unbuffered session and every SWMR append — costs 5 writes where it cost 8, since each checksummed structure is now published in a single write ([#307](https://github.com/stephenberry/hdf5-pure/issues/307)).
